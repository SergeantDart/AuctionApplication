...
public class SellerClient {
	...
	public final static int SELLER_CLIENT_PORT = 7000;
	
	public static void main(String[] args) throws IOException {
		System.out.println("This is the seller client !");
		...
		//establishing connection to the seller server side
		client = new Socket(inetAddress, SELLER_CLIENT_PORT);
		...
		//else print to the user the failed login message
		}else {
			System.out.println(loginMessage);
		}
